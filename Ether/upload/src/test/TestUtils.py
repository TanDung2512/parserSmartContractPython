...
if not './main/ether/parser/' in sys.path:
    sys.path.append('./main/ether/parser/')
if os.path.isdir('../target/main/ether/parser') and not '../target/main/ether/parser/' in sys.path:
    sys.path.append('../target/main/ether/parser/')
from ETHERLexer import ETHERLexer
